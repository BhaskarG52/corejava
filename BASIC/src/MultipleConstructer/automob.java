	    ...
	    public void changGear(int j) {
	    	...
	    	case 1:
	    		...
	    		case 2:
	    			...
	    			break;
	    		case 3:
	    			System.out.println("speed must be in between 60-80 Gear "+j);
	    			break;
	    		case 4:
	    			System.out.println("speed must be in between 80-100 Gear"+j);
	    			break;
	    		case 5:
	    			System.out.println("speed must be in between 100-120"+j);
	    			break;
	    		default:
